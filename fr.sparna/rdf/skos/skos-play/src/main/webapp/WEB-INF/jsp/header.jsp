				...
				<div class="row">
			    	...
			    	<div class="span6" id="header-menu">
			    		<ul class="nav nav-pills pull-right">
			    			<li id="header-pill-home" ${param.active == 'home' ? 'class="active"' : ''}><a href="home"><i class="icon-home"></i>&nbsp;<fmt:message key="menu.home" /></a></li>
			    			<li id="header-pill-upload" ${param.active == 'upload' ? 'class="active"' : ''}><a href="upload"><i class="icon-play"></i>&nbsp;<fmt:message key="menu.start" /></a></li>
					    	<li id="header-pill-about" ${param.active == 'about' ? 'class="active"' : ''}><a href="about"><i class="icon-info-sign"></i>&nbsp;<fmt:message key="menu.about" /></a></li>
					    	<li id="header-pill-forum"><a href="https://groups.google.com/d/forum/skos-play-discuss" target="_blank"><i class="icon-user"></i>&nbsp;<fmt:message key="menu.feedback" /></a></li>
							<li id="header-pill-lang"class="dropdown">
