...
>
		...
		<fo:table-row>
			<fo:table-cell>
				<fo:block margin-right="6px" text-align="right">
					<fo:inline keep-together.within-line="always" font-family="Nimbus Sans L, Helvetica, Trad Arabic">
	...
	<xsl:template match="disp:entry" mode="kwac">
		<fo:block font-family="Nimbus Sans L, Helvetica, Trad Arabic">
		...
		<fo:block id="{@id}">
			...
			<xsl:if test="disp:att">				
				...
				<xsl:if test="disp:att[contains(@type, 'lang:')]">
					<fo:block font-family="Nimbus Sans L, Helvetica, Trad Arabic" font-size="smaller" font-style="italic" margin-bottom="0.7mm">
				...
				<xsl:if test="disp:att[@type = 'scopeNote']">
					<fo:block text-align="justify" font-family="Nimbus Roman No9 L, Times, Trad Arabic"  font-style="italic" margin-top="0.7mm"  margin-bottom="0.7mm" line-height="95%">
	...
	<xsl:template match="disp:att" mode="table">
		...
		<fo:table-row>
			<fo:table-cell>
				<fo:block font-size="smaller" font-weight="bold" font-family="Nimbus Sans L, Helvetica, Trad Arabic">
			...
			<fo:table-cell>
				<xsl:choose>
					<xsl:when test="@type = 'definition' or @type = 'scopeNote'">
						<fo:block text-align="justify" font-style="italic" font-family="Nimbus Roman No9 L, Times, Trad Arabic">
							<xsl:apply-templates />
						</fo:block>
					</xsl:when>
					<xsl:otherwise>
