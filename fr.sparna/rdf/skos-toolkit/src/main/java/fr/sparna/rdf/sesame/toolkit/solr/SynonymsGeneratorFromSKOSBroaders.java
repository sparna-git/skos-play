...
public class SynonymsGeneratorFromSKOSBroaders {
	...
	class LabelsSPARQLHelper extends fr.sparna.rdf.sesame.toolkit.skos.GetLabelsHelper {
	...
	class BroaderSPARQLHelper extends fr.sparna.rdf.sesame.toolkit.skos.GetBroadersHelper {
