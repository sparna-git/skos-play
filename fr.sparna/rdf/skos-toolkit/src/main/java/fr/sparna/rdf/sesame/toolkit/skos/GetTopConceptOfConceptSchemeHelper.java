...
public abstract class GetTopConceptOfConceptSchemeHelper extends SelectSPARQLHelperBase {
	 ...
	 */
	public GetTopConceptOfConceptSchemeHelper(final java.net.URI conceptSchemeURI, String orderByLang) {
		super(
	...
	public static class QueryBuilder implements SPARQLQueryBuilderIfc {
		...
		public String getSPARQL() {
			String sparql = "" +
					"SELECT ?scheme ?top"+"\n" +
					"WHERE {"+"\n" +
					"	?scheme <"+SKOS.HAS_TOP_CONCEPT+"> ?top"+"\n" +
