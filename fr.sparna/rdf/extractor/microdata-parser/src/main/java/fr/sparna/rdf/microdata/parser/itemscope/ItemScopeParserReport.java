...
/**
 * This class describes the report of the {@link ItemScopeParser}.
 * Such report contains the detected {@link ItemScope}s and errors.
 *
 * @author Michele Mostarda (mostarda@fbk.eu)
 */
public class ItemScopeParserReport {

    private static final ItemScopeParserException[] NO_ERRORS = new ItemScopeParserException[0];

    private final ItemScope[] detectedItemScopes;

    private final ItemScopeParserException[] errors;

    public ItemScopeParserReport(ItemScope[] detectedItemScopes, ItemScopeParserException[] errors) {
    ...
    public ItemScopeParserReport(ItemScope[] detectedItemScopes) {
